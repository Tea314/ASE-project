...
from scams_backend.schemas.resource.device import DeviceResponse
...
async def get_buildings(
    ...
    building_response: BuildingResponse = building_service.invoke()
...
async def get_devices(
    ...
    device_response: DeviceResponse = device_service.invoke()
...
async def get_lecturers(
    ...
    lecturer_response: LecturerResponse = lecturer_service.invoke()
